# Generated by Django 4.2 on 2024-08-09 09:57
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('active', models.BooleanField(default=True, help_text='Indicates whether the entity is active.', verbose_name='Active')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('name', models.CharField(help_text='The type of relationship (e.g., Supplier, Partner).', max_length=50, unique=True, verbose_name='Relationship Type')),
                ('description', models.TextField(blank=True, help_text='Optional description of the relationship type.', null=True, verbose_name='Description')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('name', models.CharField(help_text='Name of the tag.', max_length=50, unique=True, verbose_name='Tag Name')),
            ],
            options={
                'verbose_name': 'Tag',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('created_at', models.DateTimeField(auto_now_add=True, help_text='The timestamp when the relationship was created.', verbose_name='Created At')),
                ('from_entity', models.ForeignKey(help_text='The entity from which the relationship originates.', on_delete=django.db.models.deletion.CASCADE, related_name='from_relationships', to='accounts.entity', verbose_name='From Entity')),
                ('relationship_type', models.ForeignKey(help_text='The type of relationship between the entities.', on_delete=django.db.models.deletion.CASCADE, to='accounts.relationshiptype', verbose_name='Relationship Type')),
                ('to_entity', models.ForeignKey(help_text='The entity to which the relationship points.', on_delete=django.db.models.deletion.CASCADE, related_name='to_relationships', to='accounts.entity', verbose_name='To Entity')),
            ],
            options={
        ...
        migrations.AddField(
            ...
            field=models.ManyToManyField(help_text='Entities related to this entity.', related_name='related_to_entities', through='accounts.EntityRelationship', to='accounts.entity', verbose_name='Related Entities'),
        ),
        migrations.AddField(
            model_name='entity',
            name='roles',
        ...
        migrations.AddField(
            model_name='entity',
            name='tags',
            field=models.ManyToManyField(blank=True, help_text='Tags associated with the entity for better classification.', to='accounts.tag', verbose_name='Tags'),
        ),
        migrations.AddField(
